      ...
      <div className="container mx-auto px-4 max-w-7xl py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm">
              AI Code Ecosystem Japanは、AIコーディングツールの情報を日本語で提供する総合情報サイトです。
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/guides/getting-started" className="hover:text-white transition">
                  はじめ方ガイド
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/contribute" className="hover:text-white transition">
                  貢献する
                </Link>
              </li>
            </ul>
