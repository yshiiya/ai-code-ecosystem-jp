...
export const metadata: Metadata = {
	...
	description:
		"Model Context Protocol サーバー一覧。GitHub、Filesystem、Slack連携など",
	keywords:
		"MCP, Model Context Protocol, Claude Code, GitHub MCP, Filesystem MCP",
};

export default function MCPPage() {
	const mcpByCategory = mcpServers.reduce(
		(acc, mcp) => {
			if (!acc[mcp.category]) {
				acc[mcp.category] = [];
			}
