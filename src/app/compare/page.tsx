...
export const metadata: Metadata = {
  ...
  description: '主要AIコーディングツールの詳細比較。機能、価格、特徴を一覧で確認',
          ...
          <thead>
            <tr className="bg-gray-50">
              ...
              {compareTools.map((tool) => (
                <th key={tool.id} className="p-4 font-semibold border-b text-center min-w-[120px]">
                  <div className="text-sm">{tool.name}</div>
                  <div className="text-xs text-gray-500 font-normal mt-1">{tool.category}</div>
                </th>
              ))}
            </tr>
          </thead>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-700">
                <strong>Claude Code</strong> - 日本語対応が優秀で、エージェント機能により自動的にタスクを実行
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-1">プロ開発者</h3>
              <p className="text-sm text-gray-700">
                <strong>GitHub Copilot</strong> - 全IDE対応で高速補完、企業導入実績多数
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-1">フルスタック開発</h3>
              <p className="text-sm text-gray-700">
                <strong>Cursor</strong> - IDE一体型で効率的、Composer機能で複数ファイル編集
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-1">無料で始めたい</h3>
              <p className="text-sm text-gray-700">
                <strong>Cline</strong> - オープンソースで完全無料、透明性の高い動作
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gray-100 p-6 rounded-lg">
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-start">
              ...
              <div>
                <strong>予算</strong>: 無料ツールから始めて、必要に応じて有料版へ
              </div>
            </li>
            <li className="flex items-start">
              <span className="text-primary-600 mr-2">•</span>
            ...
            <li className="flex items-start">
              <span className="text-primary-600 mr-2">•</span>
              <div>
                <strong>セキュリティ</strong>: 企業利用の場合はエンタープライズ版を検討
              </div>
            </li>
            <li className="flex items-start">
              <span className="text-primary-600 mr-2">•</span>
              <div>
                <strong>学習曲線</strong>: 初心者は日本語対応が充実したツールから
              </div>
            </li>
          </ul>
        </section>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <div className="p-2 bg-green-50 rounded">
                <strong className="text-green-700">無料</strong>: Cline, Aider, Continue.dev
              </div>
              <div className="p-2 bg-blue-50 rounded">
                <strong className="text-blue-700">$10/月</strong>: GitHub Copilot, Windsurf
              </div>
              <div className="p-2 bg-purple-50 rounded">
                <strong className="text-purple-700">$20/月</strong>: Claude Code, Cursor
              </div>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <div className="p-2 bg-yellow-50 rounded">
                <strong className="text-yellow-700">エージェント型</strong>: Claude Code, Cline, Windsurf
              </div>
              <div className="p-2 bg-orange-50 rounded">
                <strong className="text-orange-700">補完特化</strong>: GitHub Copilot, Codeium
              </div>
              <div className="p-2 bg-red-50 rounded">
                <strong className="text-red-700">Git統合</strong>: Aider, Claude Code
              </div>
            </div>
          </div>
        </div>
